...
public class DiscoveryAutoPlayUpNextFalse extends PlaybackWebTest {
	...
	public DiscoveryAutoPlayUpNextFalse() throws OoyalaException {
		super();
	}
	...
	public void testDiscoveryWithAutoPlayUpNextFalse(String testName, UrlObject url) throws OoyalaException {
		...
		try {
			...
			result = result && discoveryUpNext.getPlayerState().equalsIgnoreCase("ready");
