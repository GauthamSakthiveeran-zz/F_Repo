...
public class DiscoveryPostRollAutoPlayInitialTime extends PlaybackWebTest {
	...
	public DiscoveryPostRollAutoPlayInitialTime() throws OoyalaException {
		super();
	}
	...
	public void testDiscoveryPostRollWithInitialTime(String testName, UrlObject url) throws OoyalaException {
		...
		try {
			...
			result = result && (eventValidator.isAdPluginPresent("pulse") ? eventValidator.validate("singleAdPlayed_2", 90000)
					: eventValidator.validate("singleAdPlayed_1", 90000));
