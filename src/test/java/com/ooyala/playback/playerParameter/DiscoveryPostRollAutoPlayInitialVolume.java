...
public class DiscoveryPostRollAutoPlayInitialVolume extends PlaybackWebTest {
	...
	public DiscoveryPostRollAutoPlayInitialVolume() throws OoyalaException {
		super();
	}
	...
	public void testDiscoveryPostRollWithInitialTime(String testName, UrlObject url) throws OoyalaException {
		...
		try {
			...
			//result = result && eventValidator.validate("playing_1", 150000);
