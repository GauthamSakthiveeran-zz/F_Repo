...
public class PlaybackEnablePreloadingForPrerollTests extends PlaybackWebTest {
    ...
    public void enablePreloadingForPrerollTest(String testName, UrlObject url) throws OoyalaException {
        ...
        try {
            ...
            result = result && preloadingValidator.validateFalse("downloads", 1000);
            result = result && preloadingValidator.validateFalse("segments",500);
            result = result && preloadingValidator.validate("thirdQuartile", 10000);
            result = result && preloadingValidator.validate("downloads",3000);
            result = result && preloadingValidator.validate("segments", 2000);
