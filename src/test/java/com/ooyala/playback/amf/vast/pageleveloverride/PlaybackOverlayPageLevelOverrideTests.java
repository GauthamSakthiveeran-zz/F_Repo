...
public class PlaybackOverlayPageLevelOverrideTests extends PlaybackWebTest {
    ...
    public void prerollOverlayPageLevelOverrideTest(String testName, UrlObject url){
        boolean result= true;
        try {
            ...
            result = result && pageOverride.setAdType("overlay").validate("nonLinearAdDisplayed_1",10000);
            ...
            result = result && event.validate("played_1",30000);
