    ...
    public void testOverrideEncodingPriorities(String testName, UrlObject url) {
        ...
        try {
            ...
            if (event.isAdPluginPresent("freewheel")) {
                param = "{\"freewheel-ads-manager\":{\"fw_video_asset_id\":\"NqcGg4bzoOmMiV35ZttQDtBX1oNQBnT-\",\"html5_ad_server\":\"http://g1.v.fwmrm.net\",\"html5_player_profile\":\"90750:ooyala_html5\",\"showInAdControlBar\":true},\"initialTime\":0,\"autoplay\":false,\"encodingPriority\":[\"hls\",\"webm\",\"mp4\",\"dash\"]}";
            } else {
