 ...
 * Created by Gautham
 */
public class PlayerParametersDiscoveryUpnextEnabled extends PlaybackWebTest {
	private static Logger logger = Logger
			.getLogger(PlayerParametersDiscoveryUpnextEnabled.class);
	...
	public PlayerParametersDiscoveryUpnextEnabled() throws OoyalaException {
		super();
	}
