				...
				try
					...
					adobeUpdateButton.click();
						...
						while(true)
								...
								{
									logger.info("AdobeFlash component is loaded in chrome://components - " + versionDetails.getText());
									break;
								}
								else
								{
									
									logger.info("Error occured while loading AdobeFlash component is loaded in chrome://components");
								}
					...
					{
						logger.info("Error occured while checking if the AdobeFlash component is loaded in chrome://compoents");
