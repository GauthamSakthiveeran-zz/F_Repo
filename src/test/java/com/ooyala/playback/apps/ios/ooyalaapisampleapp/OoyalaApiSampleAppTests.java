package com.ooyala.playback.apps.ios.ooyalaapisampleapp;
...
public class OoyalaApiSampleAppTests extends PlaybackAppsTest {

	private static Logger logger = Logger.getLogger(OoyalaApiSampleAppTests.class);
	...
	//private ClickDiscoveryButtonAction clickAction;

	@Test(groups = "ooyalapisampleapp", dataProvider = "testData")
