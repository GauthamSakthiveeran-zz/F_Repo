 ...
 * Created by Gautham
 */
public class PlayerParametersDiscoveryUpnextDisabled extends PlaybackWebTest {
	private static Logger logger = Logger
			.getLogger(PlayerParametersDiscoveryUpnextDisabled.class);
	...
	public PlayerParametersDiscoveryUpnextDisabled() throws OoyalaException {
		super();
	}
