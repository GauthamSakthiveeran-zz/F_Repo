...
public class PlaylistAutoPlayWithLoop extends PlaybackWebTest {

    private PlaylistValidator playlist;
    private PlayValidator play;
    private StreamValidator streamTypeValidator;
    private EventValidator eventValidator;
    private static final Logger logger = Logger.getLogger(PlaylistAutoPlayWithLoop.class);
    public PlaylistAutoPlayWithLoop() throws OoyalaException {
        super();
    }
