package com.ooyala.playback.apps.ios.npawsampleapp;
...
public class NPAWSampleAppTests extends PlaybackAppsTest {

	private static Logger logger = Logger.getLogger(NPAWSampleAppTests.class);
	...
	@Test(groups = "npawsampleapp", dataProvider = "testData")
