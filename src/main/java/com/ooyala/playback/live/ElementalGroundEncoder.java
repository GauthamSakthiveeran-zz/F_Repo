...
public class ElementalGroundEncoder {
    ...
    private static final Logger logger = Logger.getLogger(ElementalGroundEncoder.class);
    private String url;
    ...
    public boolean resetEvent() {
        ...
        try {
            ...
            logger.error("Could not reset the elemental event" + e.getMessage());
            flag = false;
        }
        return flag;
    }
    ...
    public boolean stopEvent() {
        ...
        try {
            ...
            logger.error("Could not stop the elemental event" + e.getMessage());
            flag = false;
        }
        return flag;
    }
    ...
    public boolean startEvent() {
        try {
            ...
            if (response.getResponseCode() == 201
                ...
                Thread.sleep(40000); // Sleep 2 mins to start events
                return true;
            } else {
            ...
            logger.error("Could not start the elemental event" + e.getMessage());
            return false;
        }
    }
}
