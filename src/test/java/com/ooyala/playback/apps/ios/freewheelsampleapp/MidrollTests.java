...
public class MidrollTests extends PlaybackAppsTest {
	...
	public void testBasicPlayer(String testName, TestParameters test) throws Exception {
		...
		try {
			...
			result = result
					&& notificationEventValidator.verifyEvent(Events.AD_STARTED, "Midroll Ad has been started", 25000);
			result = result
					&& notificationEventValidator.verifyEvent(Events.AD_COMPLETED, "Midroll Ad has competed", 25000);
