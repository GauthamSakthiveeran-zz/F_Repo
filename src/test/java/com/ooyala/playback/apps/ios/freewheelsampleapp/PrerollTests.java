...
public class PrerollTests extends PlaybackAppsTest {

	private static Logger logger = Logger.getLogger(PrerollTests.class);
	...
	public void testBasicPlayer(String testName, TestParameters test) throws Exception {
		...
		try {
			...
			result = result
					&& notificationEventValidator.verifyEvent(Events.AD_STARTED, "PreRoll Ad has been started", 25000);
			result = result
					&& notificationEventValidator.verifyEvent(Events.AD_COMPLETED, "PreRoll Ad has competed", 25000);
