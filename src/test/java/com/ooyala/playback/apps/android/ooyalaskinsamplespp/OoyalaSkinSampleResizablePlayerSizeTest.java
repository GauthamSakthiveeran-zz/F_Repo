...
public class OoyalaSkinSampleResizablePlayerSizeTest extends OoyalaSkinSampleAppSkinPlaybackUtils {

	private static Logger logger = Logger.getLogger(OoyalaSkinSampleResizablePlayerSizeTest.class);
	...
	public void testOoyalaSkinPlaybackApp(String testName, TestParameters test) throws Exception {
		...
		boolean result = true;
		try {
			result = result && selectResizablePlayer();
