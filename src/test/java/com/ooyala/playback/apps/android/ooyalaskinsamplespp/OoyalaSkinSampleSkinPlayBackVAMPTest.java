...
public class OoyalaSkinSampleSkinPlayBackVAMPTest extends OoyalaSkinSampleAppSkinPlaybackUtils {

	private static Logger logger = Logger.getLogger(OoyalaSkinSampleSkinPlayBackVAMPTest.class);
	...
	public void testVastAds(String testName, TestParameters test) throws Exception {
		...
		try {
			...
			result = result && vampAdsTest(test);
