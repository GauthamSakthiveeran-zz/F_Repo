...
public class FreewheelSampleAppOverlayTests extends PlaybackAppsTest {

    private static Logger logger = Logger.getLogger(FreewheelSampleAppOverlayTests.class);
